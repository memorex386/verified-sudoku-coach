...
| Continue the smallest hosted follow-up | [Owner-only pilot](product/owner-only-coach-pilot.md) — accepted implementation scope; deployment and hosted spend remain off |
