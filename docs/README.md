...
| Check a public uniqueness receipt | [Fixture artifact checks](contracts/fixture-artifacts.md#independent-uniqueness-check) — reruns the exact solver without accepting a showcase |
