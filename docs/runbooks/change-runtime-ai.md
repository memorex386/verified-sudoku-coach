...
4. Register the prompt/schema hashes, requested model/settings, output bound, provider storage
   choice, `automaticRetry:false`, visible failure policy, and eval-suite version in
   `ai/runtime-manifest.json`.
