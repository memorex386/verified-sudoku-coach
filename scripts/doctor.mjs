...
const expectedFoundationScripts = {
  ...
  test: "node --test scripts/validation.test.mjs && npm run test:domain && npm run test:contracts && npm run test:fixture-tools",
  ...
  "test:fixture-tools": "tsc -b packages/testing --pretty false && node --test packages/testing/test/fixtures.test.mjs packages/testing/test/transforms.test.mjs scripts/fixture-source-digest.test.mjs",
